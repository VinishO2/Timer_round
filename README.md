...
* **Alertas Visuais Dinâmicos:** O DOM é manipulado para alterar as cores de fundo da tela dependendo do estado atual (amarelo para preparação, verde para descanso) e emitir um alerta visual piscante em vermelho ao fim do treino.
...
* **CSS3:** Estilização responsiva e criação de classes utilitárias para mudança de estado visual (`.tela-prep`, `.tela-descanso`, `.tela-piscando-vermelho`).
