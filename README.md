...
* [X] O tempo total do round (ex: 180 segundos)
* [X] O tempo que falta no momento
* [X] Quantos rounds foram feitos
...
* [X] Quando o utilizador clicar em "Reiniciar": O cronometro é zerado, reinicia a contagem dos rounds
* [X] Quando o utilizador clicar em "Finalizar": Volta para a tela inicial de escolha e zera tudo
* [X] Quando o utilizador selecionar a quantidade de rounds, tempo de round e descanso: os visores devem ser alterados
